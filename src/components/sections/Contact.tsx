  ...
  return (
    <div className={cx('wrap-contact')}>
      ...
      <div className={cx('wrap-contact-info')}>
        <IconMoney className={cx('icon-money')} />
...
function IconMoney({ className }: { className: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="  M49.2,27.8c-1.1-1.5-2.4-2.9-4-4.2"
        fill="none"
        stroke="#2C3E50"
      ...
      />
      <path
        d="  M26.7,20c-0.7-1.3-1.1-2.8-1.1-4.3c0-5.2,4.2-9.4,9.4-9.4s9.4,4.2,9.4,9.4c0,2.8-1.2,5.2-3.1,7"
        fill="none"
        stroke="#2C3E50"
        stroke-linecap="round"
        stroke-linejoin="round"
      ...
      />
      <path
        d="  M49.6,32.2c0,0,6.9,0.4,6.5-4.5c-0.3-3.6-2.1-4.3-3.3-2.8c-1,1.3,0,4.9,4.2,4.7c4.2-0.2,3-5.5,3-5.5"
        fill="none"
        stroke="#2C3E50"
        stroke-linecap="round"
        stroke-linejoin="round"
      ...
      />
      <path
        d="  M26.5,23.8c0,0,8-1.5,12.5,2.1"
        fill="none"
        stroke="#2C3E50"
        stroke-linecap="round"
        stroke-linejoin="round"
